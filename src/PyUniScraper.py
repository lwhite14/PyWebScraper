...
class PyUniScraper(object):
    def __init__(self):
        ...
        parser.add_argument('university', help='University to get information for [manchester|birmingham|surrey|portsmouth|rmit|sheffield|leeds|york|uwe|lancaster|aberdeen]')
